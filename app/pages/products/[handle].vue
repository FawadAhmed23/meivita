...
<template>
  <section v-if="product" class="flex flex-col" :class="extraCssForImageWrapper">
...
<style>
:root {
  --product-gradient-from-top-height: 300px;
}

.product-gradient {
  background: radial-gradient(circle at 50% var(--product-gradient-from-top-height), rgba(19 82 5 / 0.59) 0%, rgba(81, 149, 24, 0.15) 400px, rgba(19, 82, 5, 0.1) 600px, rgba(0, 0, 0, 0) 1000px);
}

@media (min-width: 640px) {
  .product-gradient {
    background: radial-gradient(circle at 40% var(--product-gradient-from-top-height), rgba(19 82 5 / 0.59) 0%, rgba(81, 149, 24, 0.15) 400px, rgba(19, 82, 5, 0.1) 600px, rgba(0, 0, 0, 0) 1000px);
  }
}

@media (min-width: 860px) {
  .product-gradient {
    background: radial-gradient(circle at 25% var(--product-gradient-from-top-height), rgba(19 82 5 / 0.59) 0%, rgba(81, 149, 24, 0.15) 400px, rgba(19, 82, 5, 0.1) 600px, rgba(0, 0, 0, 0) 1000px);
  }
}
...
@media (min-width: 1280px) {
  .product-gradient {
    background: radial-gradient(circle at 20% var(--product-gradient-from-top-height), rgba(19 82 5 / 0.59) 0%, rgba(81, 149, 24, 0.15) 400px, rgba(19, 82, 5, 0.1) 600px, rgba(0, 0, 0, 0) 1000px);
  }
}
</style>
